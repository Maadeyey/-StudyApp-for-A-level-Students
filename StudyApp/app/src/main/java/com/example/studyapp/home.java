...
public class home extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button1 = (Button) rootView.findViewById(R.id.mathbutton2);
        button2 = (Button) rootView.findViewById(R.id.chemitrybutton2);
        button3 = (Button) rootView.findViewById(R.id.physicsbutton2);
        button4 = (Button) rootView.findViewById(R.id.biologybutton2);
        button5 = (Button) rootView.findViewById(R.id.videoButton);
